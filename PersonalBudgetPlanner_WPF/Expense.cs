...
{
    abstract class Expense// abstarct class containing a method to calculate monthly repayments. Other classes inherit from this class.
    {
        protected double monthlyRepayment;
        public abstract double calcMonthlyRepayment(double grossIncome);//this method is made abstract since car, rent and homeloans require monthly payments
    }
}
